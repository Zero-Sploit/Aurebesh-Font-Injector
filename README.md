...
2. **Add the Script**:
   - Click [here](https://raw.githubusercontent.com/Zero-Sploit/Aurebesh-Font-Injector/main/AurebeshFontInjector-0.1.user.js) to install the script directly in Tampermonkey, or
